...
const navLinks: NavItem[] = [
  ...
  { 
    ...
    dropdown: [
      ...
      { label: "Enterprise Connectivity", to: "/services/enterprise-connectivity" },
      { label: "Cloud Solutions", to: "/services/cloud-solutions" },
      { label: "Cyber Security", to: "/services/cyber-security" },
      { label: "Smart Integration", to: "/services/smart-integration" },
      { 
      ...
      { label: "ISP Device Management", to: "/services/isp-device-management" },
      { label: "Firewall Solutions", to: "/services/firewall-solutions" },
      { label: "Speed Test", to: "/speed-test" },
      { label: "Deep Packet Inspection", to: "/services/deep-packet-inspection" },
      { label: "Satellite Connectivity", to: "/services/satellite-connectivity" },
    ]
  },
