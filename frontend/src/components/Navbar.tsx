          ...
          {navLinks.map((link) => (
            link.dropdown ? (
              ...
              >
                ...
                {/* Dropdown Menu */}
                {dropdownOpen && (
                  <div className="absolute top-full left-0 mt-1 w-56 glass-dark backdrop-blur-xl rounded-xl shadow-xl border border-white/10 py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                    {link.dropdown.map((item) => (
                      item.subdropdown ? (
                        ...
                        >
                          <button
                            className={`w-full px-4 py-2.5 text-sm font-medium transition-colors flex items-center justify-between ${
                              isActive(item.to)
                                ? "text-primary bg-primary/10"
                          ...
                          {/* Subdropdown Menu */}
                          {subdropdownOpen && (
                            <div className="absolute top-0 left-full ml-1 w-48 glass-dark backdrop-blur-xl rounded-xl shadow-xl border border-white/10 py-2 animate-in fade-in slide-in-from-left-2 duration-200">
