      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide -mx-4 px-4">
          {testimonials.map((t) => (
            <div
              key={t.name}
              className="glass min-w-[300px] max-w-[320px] rounded-[40px] p-8 flex flex-col items-center text-center snap-center shrink-0 hover:royal-glow transition-all duration-500"
            >
