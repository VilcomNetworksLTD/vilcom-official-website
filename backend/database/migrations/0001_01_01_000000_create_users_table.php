...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            // ── Emerald integration fields ──
            $table->unsignedBigInteger('emerald_mbr_id')->nullable();       // CustomerID from Emerald
            $table->unsignedBigInteger('emerald_account_id')->nullable(); // AccountID (service)
            ...
            // Soft deletes + Laravel defaults
            $table->softDeletes();
            $table->rememberToken();
            $table->timestamps();

            // ── Indexes ──
            $table->index('emerald_mbr_id');
            $table->index('email');
            $table->index('phone');
            $table->index('status');
